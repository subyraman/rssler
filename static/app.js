...
(function(angular) {
  ...
  AdvancedSearchController = (function() {
    function AdvancedSearchController($modalInstance, feedService, categoryService, searchService) {
      ...
      this.searchData = {};
      this.feedService.getAllFeeds().then((function(_this) {
        return function(response) {
          return _.replaceArray(_this.feeds, response.data.objects);
        };
      })(this));
    }
  ...
  EditCategoryController = (function() {
    function EditCategoryController($modalInstance, viewService, categoryService, feedService) {
      ...
      this.feedService.getAllFeeds().then((function(_this) {
        return function(response) {
          var selectedFeeds;
          _.replaceArray(_this.feeds, response.data.objects);
          selectedFeeds = _.where(_this.feeds, function(feed) {
            return _.contains(selectedIds, feed.id);
          });
          return _.replaceArray(_this.selectedFeeds, selectedFeeds);
        };
      })(this));
    }
    ...
    EditCategoryController.prototype.isValid = function() {
      ...
      if (this.categoryService.categoryExists(this.categoryData.title)) {
        this.alerts.push({
  ...
  FeedController = (function() {
    ...
    FeedController.prototype.updatePage = function() {
      if (this.currentView.data.type === 'category') {
        ...
        return this.searchService.search(this.currentView.data.searchData, this.currentView.data.page);
      } else {
...
(function(angular) {
  ...
  CategoryService = (function() {
    ...
    CategoryService.prototype.categoryExists = function(title) {
      return _.where(this.categories, {
        'title': title
      }).length > 0;
    };
